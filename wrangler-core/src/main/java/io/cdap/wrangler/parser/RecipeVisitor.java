...
public final class RecipeVisitor extends DirectivesBaseVisitor<RecipeSymbol.Builder> {
  ...
  /**
 * A Directive can include a byte size (e.g., 10KB, 1.5MB, 2GB).
 * This visitor method extracts the BYTE_SIZE token into a ByteSize object.
 */
  @Override
  ...
  /**
   * A Directive can include a time duration (e.g., 200ms, 2.5s).
   * This visitor method extracts the TIME_DURATION token into a TimeDuration object.
   */
  @Override
