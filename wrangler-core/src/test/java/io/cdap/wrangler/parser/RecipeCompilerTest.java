...
public class RecipeCompilerTest {
  ...
  public void testByteSizeParsing() throws Exception {
    String[] recipe = new String[] {
      "parse-as-csv :body ',' true;",
      "aggregate-stats :data_transfer_size :response_time total_size_mb total_time_sec 10kb"
    };
  ...
  public void testTimeDurationParsing() throws Exception {
    String[] recipe = new String[] {
      "parse-as-csv :body ',' true;",
      "aggregate-stats :data_transfer_size :response_time total_size_mb total_time_sec 5ms"
    };
